...
public static partial class Pattern
{
    ...
    public static AnyLambdaExpressionPattern AnyLambdaExpression(PatternNode body = null,
        ParameterListPattern parameterList = null, Action<LambdaExpressionSyntax> action = null)
    {
        return new AnyLambdaExpressionPattern(body, parameterList, action);
    }

    public static SingleStatementPattern SingleStatement(StatementPattern statement = null,
        Action<StatementSyntax> action = null)
    {
